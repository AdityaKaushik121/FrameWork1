...
public class RTTC_063_POM {
private WebDriver driver; 
	
	public RTTC_063_POM(WebDriver driver) {
		this.driver = driver; 
	...
	@FindBy(xpath="//li//a[@href='http://retailm1.upskills.in/account/logout']//span//span[@class='tb_icon']//i[@class='fa fa-sign-out']")  //logout
